...
extern int ej_get_simple_firmware_version(int eid, webs_t wp, int argc, char_t **argv);
...
extern int generate_sshkey(webs_t wp);
extern int ej_get_dbkey_status(int eid, webs_t wp, int argc, char_t **argv);
#endif

extern int create_partition(webs_t wp);
...
extern int ej_get_wanuptime(int eid, webs_t wp, int argc, char_t **argv);
extern int ej_show_macadd(int eid, webs_t wp, int argc, char_t **argv);

extern int ej_get_atuc(int eid, webs_t wp, int argc, char_t **argv);
extern int ej_get_dspver(int eid, webs_t wp, int argc, char_t **argv);
extern int ej_get_failtrain(int eid, webs_t wp, int argc, char_t **argv);
extern int ej_get_freemem(int eid, webs_t wp, int argc, char_t **argv);

extern char * string_uptime();

extern int pippo_start(webs_t wp);
