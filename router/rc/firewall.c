...
/*volatile int nat_pre_flag  = 0;*///xiaoqin delete 2005.02.04 �漰�˱���ȫ���޸�
...
void nat_prerouting(){
	...
	/* Dom 2007/01/05 Fixed DHCP Relay packet be filter issue */
	if (nvram_match("lan_proto", "dhcprelay"))
		save2file("-A PREROUTING -p udp -m udp -i %s --dport 67:68 -j ACCEPT\n", wan_if_name[conn_no] );
	/* Dom 2006/05/22 Fixed remote login by lan_cclass */
