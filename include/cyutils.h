...
/*This is now in router_type.h
#define HARDWARE_TYPE            0		//0:AnnexA  1:AnnexB
*/

#define CYBERTAN_VERSION	"1.01.12"
#define LANG_VERSION		"1.01.12"    //for lang.bin version control(setupwizard)

#define RELEASE_DATE            __DATE__ //2006/03/06 Joanne add

#define NEPTUNE_VERSION		"Neptune354"
#define MINOR_VERSION		"v0.2" 
